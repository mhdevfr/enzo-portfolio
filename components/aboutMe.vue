<template>
  <div class="w-3/4 h-2/3 rounded-2xl" id="about">
    <div class="flex items-start justify-normal flex-col p-10">
      <div class="flex">
        <div class="ml-10 flex flex-col justify-center mr-10">
          <h1 class="text-white text-4xl font-bold brico-800">About me.</h1>
          <p class="text-white text-xl mt-5 brico-200 first-letter:text-white">
          ...
          <div class="flex mt-5 justify-end mr-10">
